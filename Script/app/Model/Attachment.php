...
class Attachment extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'post_id', 'filename', 'blurredFilename', 'type', 'id', 'driver', 'payment_request_id', 'message_id'
    ];

    protected $appends = ['attachmentType', 'path', 'thumbnail', 'blurredPath'];
    ...
    public function getBlurredPathAttribute()
    {
        return AttachmentServiceProvider::getFileBlurredPathByAttachment($this);
    }
